  ...
  return (
    <div style={{ textAlign: 'center', padding: 20 }}>
      ...
      <svg width="140" height="90" viewBox="0 0 140 90">
        <path d="M 15 80 A 55 55 0 1 1 125 80" fill="none" stroke="rgba(0,0,0,0.08)" strokeWidth="6" strokeLinecap="round" />
        ...
        <text x="70" y="68" textAnchor="middle" fill="var(--text)" fontFamily="DM Mono" fontSize="16" fontWeight="500">{score}</text>
      </svg>
